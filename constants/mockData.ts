...
export const workerProfiles: { [workerID: string]: WorkerProfile } = {
  w001: {
    ...
    profilePicture: null,
    previousWork: [
      { title: 'Bathroom Leak Repair', rating: 4.9, timeAgo: '2 weeks ago', review: 'Very professional and quick.' },
      { title: 'Kitchen Tap Installation', rating: 5.0, timeAgo: '1 month ago', review: 'Excellent work, highly recommended.' },
      { title: 'Full Plumbing Check', rating: 4.8, timeAgo: '3 months ago', review: 'Thorough job.' },
      { title: 'Water Heater Repair', rating: 5.0, timeAgo: '6 months ago', review: 'Fixed it perfectly.' },
    ],
  },
  w006: {
    workerID: 'w006',
    ...
    profilePicture: null,
    previousWork: [
      { title: 'Daily Lunch Preparation', rating: 4.8, timeAgo: '1 week ago', review: 'Great food, very punctual.' },
      { title: 'Party Catering', rating: 4.6, timeAgo: '2 months ago', review: 'Everyone loved the food.' },
    ],
  },
};
...
export const chatMessages: ChatMessage[] = [
  {
    messageID: 'm001',
    senderID: 'u001',
    content: 'Hi Rajesh, What will be the things required for the repair, Tap\'s broken',
    timestamp: '11:32 AM',
    isMe: true,
  },
  {
